...
**Repository:** https://github.com/SoftwareUnderstanding/inspect4py
...
**Evidence:** W001 detected: pyproject.toml contains software requirements without versions: astor, astor, graphviz, graphviz, click, click, pigar, pigar, json2html, json2html, configparser, configparser, tree-sitter, tree-sitter, requests, requests, bigcode_astgen, GitPython
...
```json
{
  ...
  "license": {
    ...
    "identifier": "https://spdx.org/licenses/BSD-2-Clause"
  },
  ...
  "copyrightHolder": "Rosa Filgueira, St. Andrews University, Edinburgh",
  "copyrightYear": "2021",
  ...
  "buildInstructions": [
    "https://github.com/SoftwareUnderstanding/inspect4py/tree/main/docs",
