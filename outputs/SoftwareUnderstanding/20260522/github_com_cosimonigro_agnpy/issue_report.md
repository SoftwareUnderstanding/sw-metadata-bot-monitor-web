...
**Evidence:** P004 detected: metadata files README property points to homepage/wiki instead of README file: https://agnpy.readthedocs.io/en/latest/

**Suggestion:** Update the README property so it points directly to your actual README file (https://raw.githubusercontent.com/cosimoNigro/agnpy/master/README.md) instead of your homepage.

### [P014](https://w3id.org/rsmetacheck/catalog/#P014)
**Evidence:** P014 detected: metadata files Identifier uses bare DOI instead of full URL: '10.5281/zenodo.4055175'

**Suggestion:** You should include the full DOI URL form in your metadata (e.g., https://doi.org/10.5281/zenodo.4055175)

## ⚠️ Warnings (3)

### [W001](https://w3id.org/rsmetacheck/catalog/#W001)
**Evidence:** W001 detected: codemeta.json contains software requirements without versions: https://github.com/cosimoNigro/agnpy#dependencies, sherpa, pre-commit, wheel, sphinx-astropy, nbsphinx, ipython, ipykernel, docutils
...
**Evidence:** W002 detected: metadata files dateModified '2023-02-12T00:00:00' is outdated compared to repository date '2026-05-19T23:34:27'

**Suggestion:** The data in the metadata file should be updated to be aligned with the date of the latest release (2026-05-19T23:34:27).
