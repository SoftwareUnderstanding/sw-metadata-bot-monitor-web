...
**Evidence:** P008 detected: codemeta.json Software requirements contain invalid URLs: https://github.com/cds-astro/mocpy/blob/master/requirements/environment.yml
...
**Evidence:** W001 detected: codemeta.json contains software requirements without versions: https://github.com/cds-astro/mocpy/blob/master/requirements/environment.yml, astropy, numpy
...
**Evidence:** W002 detected: metadata files dateModified '2023-12-04T00:00:00' is outdated compared to repository date '2026-05-20T09:23:08'

**Suggestion:** The data in the metadata file should be updated to be aligned with the date of the latest release (2026-05-20T09:23:08).

### [W004](https://w3id.org/rsmetacheck/catalog/#W004)
**Evidence:** W004 detected: metadata files Programming languages without versions: Rust, Python 3
