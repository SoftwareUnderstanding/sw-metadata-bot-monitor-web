...
**Evidence:** P001 detected: codemeta.json version '2.0' does not match release version '2.1'
...
**Evidence:** P004 detected: metadata files README property points to homepage/wiki instead of README file: https://gammapy.org
...
**Evidence:** W001 detected: pyproject.toml contains software requirements without versions: requests, requests, tqdm, tqdm, wheel, Cython, git+https://github.com/gammapy/gammapy#egg=gammapy
...
**Evidence:** W002 detected: metadata files dateModified '2026-04-02T00:00:00' is outdated compared to repository date '2026-05-21T15:15:37'

**Suggestion:** The data in the metadata file should be updated to be aligned with the date of the latest release (2026-05-21T15:15:37).
