...
**Repository:** https://gitlab.in2p3.fr/escape2020/wp3/zenodoci
...
**Evidence:** P012 detected: metadata files downloadURL is outdated or invalid: https://gitlab.in2p3.fr/escape2020/wp3/zenodoci/-/archive/v1.0/zenodoci-v1.0.tar.gz

**Suggestion:** You need to update the downloadURL field (https://gitlab.in2p3.fr/escape2020/wp3/zenodoci/-/archive/v1.0/zenodoci-v1.0.tar.gz) to point to your latest release or current distribution source.

## ⚠️ Warnings (2)

### [W001](https://w3id.org/rsmetacheck/catalog/#W001)
**Evidence:** W001 detected: codemeta.json contains software requirements without versions: requests, json
